...
public class DPforHrm {

    @DataProvider(name = "validData", parallel = true)
    public Object[][] validDataProvider() {
        return getExcelData("src/test/resources/DPforOrangehrmLogin.xlsx", "Sheet1");
    }

    @DataProvider(name = "invalidData", parallel = true)
    public Object[][] invalidDataProvider() {
        return getExcelData("src/test/resources/DPforOrangehrmLogin.xlsx", "Sheet2");
    }
